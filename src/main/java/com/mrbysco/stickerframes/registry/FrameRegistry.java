...
public class FrameRegistry {
	...
	public static final RegistryObject<Item> STICKER_FRAME_ITEM = ITEMS.register("sticker_frame", () -> new StickerFrameItem(FrameRegistry.STICKER_FRAME::get, new Item.Properties()));
	public static final RegistryObject<Item> GLOW_STICKER_FRAME_ITEM = ITEMS.register("glow_sticker_frame", () -> new StickerFrameItem(FrameRegistry.GLOW_STICKER_FRAME::get, new Item.Properties()));
	public static final RegistryObject<Item> GUI_STICKER_FRAME_ITEM = ITEMS.register("gui_sticker_frame", () -> new StickerFrameItem(FrameRegistry.GUI_STICKER_FRAME::get, new Item.Properties()));
	public static final RegistryObject<Item> GLOW_GUI_STICKER_FRAME_ITEM = ITEMS.register("glow_gui_sticker_frame", () -> new StickerFrameItem(FrameRegistry.GLOW_GUI_STICKER_FRAME::get, new Item.Properties()));
	...
	public static final RegistryObject<CreativeModeTab> FRAME_TAB = CREATIVE_MODE_TABS.register("tab", () -> CreativeModeTab.builder()
